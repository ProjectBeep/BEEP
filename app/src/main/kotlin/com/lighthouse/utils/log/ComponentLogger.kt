...
import com.lighthouse.beep.data.remote.BuildConfig
import javax.inject.Inject

private const val LOGGER_TAG = "ComponentLogger"
...
private fun Fragment.printLifecycle(lifecycleScope: String) {
    if (BuildConfig.DEBUG) {
        Log.d(LOGGER_TAG, "[Fragment] $lifecycleScope - $javaClassName(${hashCode()})")
    }
}

private fun Activity.printLifecycle(lifecycleScope: String) {
    if (BuildConfig.DEBUG) {
        Log.d(LOGGER_TAG, "[Activity] $lifecycleScope - $javaClassName(${hashCode()})")
    }
}
